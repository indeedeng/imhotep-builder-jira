...
public class TestCustomFieldValue {
    ...
    public void testExpandedWithChildFromInitial() throws IOException {
        final String text = "{\"self\":\"https://bugs.indeed.com/rest/api/2/customFieldOption/20661\",\"value\":\"Misconfiguration\",\"id\":\"20661\",\"child\":{\"self\":\"https://bugs.indeed.com/rest/api/2/customFieldOption/20669\",\"value\":\"App Config\",\"id\":\"20669\"}}";
        final JsonNode node = OBJECT_MAPPER.readTree(text);
    ...
    public void testExpandedNoChildFromInitial() throws IOException {
        final String text = "{\"self\":\"https://bugs.indeed.com/rest/api/2/customFieldOption/20661\",\"value\":\"Misconfiguration\",\"id\":\"20661\"}";
        final JsonNode node = OBJECT_MAPPER.readTree(text);
        final CustomFieldValue field = CustomFieldValue.customFieldFromInitialFields(directCause, node);
    ...
    public void testSeparateWithChildFromInitial() throws IOException {
        final String text = "{\"self\":\"https://bugs.indeed.com/rest/api/2/customFieldOption/20781\",\"value\":\"Config\",\"id\":\"20781\",\"child\":{\"self\":\"https://bugs.indeed.com/rest/api/2/customFieldOption/20814\",\"value\":\"Other\",\"id\":\"20814\"}}";
        final JsonNode node = OBJECT_MAPPER.readTree(text);
    ...
    public void testSeparateWithoutChildFromInitial() throws IOException {
        final String text = "{\"self\":\"https://bugs.indeed.com/rest/api/2/customFieldOption/20787\",\"value\":\"DNS\",\"id\":\"20787\"}";
        final JsonNode node = OBJECT_MAPPER.readTree(text);
        final CustomFieldValue field = CustomFieldValue.customFieldFromInitialFields(sysadCategories, node);
