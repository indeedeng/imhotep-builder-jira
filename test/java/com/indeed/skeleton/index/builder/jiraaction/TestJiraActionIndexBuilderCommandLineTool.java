...
public class TestJiraActionIndexBuilderCommandLineTool {
    ...
    public void testArrayToCommanDelimetedString() {
        ...
        for (final Map.Entry<String, String[]> entry : values.entrySet()) {
            ...
            final String actual = JiraActionIndexBuilderCommandLineTool.arrayToCommaDelimetedString(entry.getValue());
    ...
    public void testNullArrayToCommaDelimetedString() {
        ...
        final String actual = JiraActionIndexBuilderCommandLineTool.arrayToCommaDelimetedString(null);
        Assert.assertEquals(expected, actual);
    }
}
